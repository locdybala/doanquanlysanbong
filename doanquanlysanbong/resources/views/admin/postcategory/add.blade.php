                ...
                <div class="basic-form">
                    <form method="POST" action="{{ route('addCategoryPost') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input data-validation="length" data-validation-length="min3" onkeyup="ChangeToSlug()" id="name_categorypost" data-validation-error-msg="Không được để trống" type="text" name="name" class="form-control input-rounded" placeholder="Tên loại sân">
                        </div>
                        <div class="form-group">
                            <label>Slug</label>
