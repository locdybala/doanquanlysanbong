        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form method="POST" action="{{ route('addPitch') }} " enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            <label>Tên sân</label>
                            <input type="text" name="name" class="form-control input-rounded" placeholder="Tên sân">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Mô tả</label>
                            <textarea class="form-control  input-rounded" name="description" id="ckeditor1" rows="3" ></textarea>
                        </div>
                        <div class="form-group">
